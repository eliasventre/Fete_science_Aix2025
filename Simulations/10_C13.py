...
# -----------------------------
dose = 50
treatment_duration = 84   # giorni totali di trattamento (come nel tuo script)
...
fig.suptitle("Taille Grosse - Dose Moyenne - Fréquence Elevée - Durée Courte", fontsize=16, y=0.98)
